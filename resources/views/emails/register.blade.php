...
@section('content')
	...
	@include('beautymail::templates.widgets.articleStart')
		<h2 style="font-family: calibri;" class="secondary"><strong>Biodata Registrasi Admin</strong></h2>
		...
		<tr>
			<td>Verifikasi</td>
			<td>{!! url('http://www.game.pesanbungkus.com/api/auth/verifikasi?code=').$user->verification !!}</td>
		</tr>		
		<tr>
			<td>Verifikasi</td>
			<td>{!! url('/api/auth/verifikasi?code=').$user->verification !!}</td>
		</tr>		
		</table>
